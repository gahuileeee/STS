...
<body>
  ...
  <div id="section">
    <h2 id="center">고객등록화면</h2>
    
      <!-- 고정으로 하기 number! -->
      <div id="form" >

      <form style="margin-top: 70px;" action="<c:url value="/register/resp00"/>" method="post">

      <label>고객번호: <input type="number" name="number" value= "<%= request.getAttribute("num") %>" readonly></label>
        <br>
      <label>고객이름: <input type="text" name="name"></label>
        <br>
      <label>전화번호: <input type="text" name="tell"></label>
        <br>
      <label>이메일: <input type="mail" name="mail"></label>   
        <br>
      <label>고객등급(P,G,S): <input type="text" name="grade"></label>  
        <br>
        <br>
    ...
    <br>
    <laber ><a href="<c:url value="/home"/>" ><input type="submit" value="[취소]"></a></laber>
  </div>
  </div>
